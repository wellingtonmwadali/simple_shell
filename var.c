...
/**
 * test_chain_delimeter - checks if current char  in buffer is  chain delimiter
...
/**
 * verify_chain - verifies if chaining should continue based on the last status
 * @info: the parameter struct
 * @buf: the character buffer
 * @p: address of the current position in buf
...
/**
 * swap_string - swaps the old string with the new one
